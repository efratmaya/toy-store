      ...
      public Product Get(int id)
        {
            ...
            DO.enumCategory.TryParse(product1?.Element("Category")?.Value, out DO.enumCategory myCategory); ;
        ...
        public IEnumerable<Product> ReadAll(Func<Product, bool>? func=null)
        {
            ...
            {
                DO.enumCategory.TryParse(product?.Element("Category")?.Value, out DO.enumCategory myCategory); ;
